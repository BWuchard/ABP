...
year = 2021
antigens = ['DT', 'DTP', 'HepB', 'Hib', 'HPV', 'MMR', 'JE', 'MenA', 'PCV', 'Rota', 'TCV', 'YF', 'OPV']
antigen_doses = {'DT':3,'DTP':3,'HepB':3,'Hib':3,'HPV':2,'JE':2, 'MenA':3,'MMR':2,'OPV':4,'PCV':3,'Rota':2,'TCV':3,'YF':1}
print(antigens)
n_antigens = len(antigens)
print(n_antigens)
vaccines = ['DT', 'JE', 'Hib' 'MenA', 'DTP', 'DTP-HepB-Hib-IPV', 'DTP-HepB-IPV', 'DTP-Hib', 'DTP-Hib-IPV', 'DTP-IPV', 'DTP', 'DTP-HepB-Hib', 'MenA', 'HepB', 'HPV', 'IPV', 'MMR', 'PCV', 'Rota', 'TCV', 'YF', 'OPV'] 
...
Gavi47 = ['Afghanistan', 'Bangladesh', 'Benin',	'Burkina Faso',	'Burundi', 'Cambodia',	'Cameroon', 'CAR',  'Chad', 'Comoros',	"Côte d'Ivoire", 'Dijibouti', 'DRC', 'Eritrea',	'Ethiopia', 'Gambia', 'Ghana', 'Guinea', 'Guinea-Bissau', 'Haiti', 'Kenya', 'Kyrgyzstan', 'Lesotho', 'Liberia',	'Madagascar', 'Malawi',	'Mali',	'Mauritania', 'Mozambique', 'Myanmar',	'Nepal', 'Niger', 'North Korea', 'Pakistan', 'Rwanda', 'São Tomé', 'Senegal', 'Sierra Leone', 'South Sudan', 'Sudan', 'Tajikistan', 'Tanzania',	'Togo',	'Uganda', 'Yemen', 'Zambia', 'Zimbabwe']
Gavi76 = ['Afghanistan', 'Albania', 'Angola', 'Armenia', 'Azerbaijan', 'Bangladesh', 'Benin', 'Bhutan', 'Bolivia', 'Bosnia', 'Burkina Faso', 'Burundi',	'Cambodia', 'Cameroon',	'CAR', 'Chad', 'China', 'Comoros', 'Congo', "Côte d'Ivoire", 'Cuba', 'Dijibouti', 'DRC', 'Eritrea', 'Ethiopia',	'Gambia', 'Georgia', 'Ghana', 'Guinea', 'Guinea-Bissau', 'Guyana', 'Haiti', 'Honduras',	'India', 'Indonesia', 'Kenya', 'Kiribati', 'Kyrgyzstan', 'Laos', 'Lesotho', 'Liberia', 'Madagascar', 'Malawi', 'Mali', 'Mauritania', 'Moldova',	'Mongolia', 'Mozambique', 'Myanmar', 'Nepal', 'Nicaragua', 'Niger', 'Nigeria', 'North Korea', 'Pakistan', 'Papua New Guinea', 'Rwanda', 'São Tomé', 'Senegal', 'Sierra Leone', 'Solomon Isl.', 'South Sudan', 'Sri Lanka', 'Sudan', 'Tajikistan', 'Tanzania', 'Timor-Leste', 'Togo', 'Turkmenistan', 'Uganda', 'Ukraine', 'Uzbekistan', 'Viet Nam', 'Yemen', 'Zambia', 'Zimbabwe']
...
cp_df_sorted = pd.read_excel('47criteria.xlsx')
...
# Read the Excel file
excel_file = 'C:\\Users\\Bailey\\Downloads\\ResearchJunk\\GaviPAHORecreation\\Gavi\\47\\1M_g_b.xlsx'  # Replace with the actual file path
...
if selected_list is Gavi47:
    selected_dataframe = unicef_pr_df
if selected_list is Gavi76:
    selected_dataframe = unicef_pr_df
...
country_param_df_sum = pd.read_excel('47criteria.xlsx')
...
def write_output_to_file(output):
    with open("1M_g_b.dat", "a") as file:
        file.write(output + '\n')
